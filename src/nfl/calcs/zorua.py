...
def zorua_size(
    ...
    zorua_avg_weight = (
        zorua_height_variant**power * ZORUA_POKEMON_SETTINGS.pokedex_weight_kg
    )

    zorua_weight = (
        zorua_avg_weight + weight_index * ZORUA_POKEMON_SETTINGS.weight_std_dev
    )
