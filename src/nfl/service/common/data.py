...
from nfl.proto.holoholo import HoloPokemonMove, HoloWeatherCondition, HoloTempEvoId, HoloCharacterCategory
from nfl.proto.templates import FRIENDSHIP_MILESTONE_SETTINGS, TYPE_EFFECTIVE, WEATHER_AFFINITIES, PLAYER_LEVEL, POKEMON_SETTINGS, MOVE_SETTINGS, COMBAT_MOVE, POKEMON_EXTENDED_SETTINGS, ROCKET_SETTINGS, NON_COMBAT_MOVE_SETTINGS, STATIONED_POKEMON_TABLE_SETTINGS, FORM_SETTINGS
